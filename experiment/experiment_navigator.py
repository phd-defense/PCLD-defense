...
from experiment.train_adv_trades_victim_clf import main_train_adv_trades_victim_clf
...
def apply_experiment(args: argparse.Namespace, experiment: str,  device: str):
    ...
    if args.experiment_type == 'train_victim_clf':
    ...
    elif args.experiment_type == 'train_adv_trades_victim_clf':
        params = {'experiment': experiment,
                  'ds_local_path': args.ds_local_path,
                  'device': device,
                  'batch_size': args.batch_size,
        ...
        check_hyper_params(params)
        main_train_adv_trades_victim_clf(**params)
